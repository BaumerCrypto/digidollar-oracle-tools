...
This script is the reference implementation for the Gitter network status bot posting to `#digidollar:gitter.im`. First deployed 2026-06-16 (v1.2, GitHub issue #18), maintained and iterated continuously since. Currently at v1.8.1 with dual-instance testnet + mainnet monitoring running under my authorship.
...
| oracle-network-status.sh | v1.8.1 |
