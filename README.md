...
| Windows 10/11 | [`oracle-monitor.ps1`](oracle-monitor.ps1) | [`config.template.ps1`](config.template.ps1) | 2.10.1-win.1 |
...
| oracle-monitor.ps1 | v2.10.1-win.1 |
